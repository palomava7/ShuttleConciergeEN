...
<?php require 'modules/header.php'; ?>
	...
	<?php 
		...
		if ($_GET["type"]=="round trip") {
			$type_text="Round Trip";
			$price_type = "round trip";
			$type = "round-trip";
		}
		if ($_GET["type"]=="arrival") {
			$type_text="Airport - Hotel";
			$price_type = "one way";
			$type = "arrival";
		}
		if ($_GET["type"]=="departure") {
			$type_text="Hotel - Airport";
			$price_type = "one way";
			$type = "departure";
		}
	...
	<form action="ajax/book.php" class="book" id="bookForm">
		...
		<fieldset>
			<legend>Choose a type of service</legend>
			
			<div class="option">
				<div class="service">
					<img src="img/servicio-colectivo.png" alt="Shared Service">
				</div>
				<!--div class="details">
					...
					<a href="#shared_includes" class="includesLink">See All</a>
				</div-->
				<div class="quote">
					<div class="type"><?php echo $type_text; ?></div>
					<div class="price">$<?php echo $shared_price*$pax; ?><span class="currency">USD</span></div>
					<div class="pax"><?php echo $pax; ?> <?php echo $pax>1?"passenger":"passengers"; ?></div>
					<div class="details"><a href="#shared_includes" class="includesLink">It Includes...</a></div>
				</div>
			...
			<div class="option active">
				<div class="service">
					<img src="img/servicio-privado.png" alt="Private Service">
				</div>
				<!--div class="details">
					<h4>This Service Includes:</h4>
					<ul>
					...
					<a href="#private_includes" class="includesLink">See All</a>
				</div-->
				<div class="quote">
					<div class="type"><?php echo $type_text; ?></div>
					<div class="price">$<?php echo $private_price; ?><span class="currency">USD</span></div>
					<div class="pax"><?php echo $pax; ?> <?php echo $pax>1?"passenger":"passengers"; ?></div>
					<div class="details"><a href="#private_includes" class="includesLink">It Includes...</a></div>
				</div>
				<div class="radiobutton">
			...
			<div class="option">
				<div class="service">
					<img src="img/servicio-premium.png" alt="Premium Service">
				</div>
				<!--div class="details">
					<h4>This Service Includes</h4>
					<ul>
					...
					<a href="#premium_includes" class="includesLink">See All</a>
				</div-->
				<div class="quote">
					<div class="type"><?php echo $type_text; ?></div>
					<div class="price">$<?php echo $premium_price; ?><span class="currency">USD</span></div>
					<div class="pax"><?php echo $pax; ?> <?php echo $pax>1?"passenger":"passengers"; ?></div>
					<div class="details"><a href="#premium_includes" class="includesLink">It Includes...</a></div>
				</div>
				<div class="radiobutton">
		...
		<fieldset>
			<legend>Fill your contact information</legend>
			<div>
		...
		<fieldset>
			<legend>Choose a payment metod</legend>
			<div>
				...
				<input type="radio" name="payment" id="cash" value="cash"><label for="cash" class="radioLabel">Cash</label>
			</div>
		</fieldset>
		<?php if ($type == "arrival" || $type == "round-trip") { ?>
		<fieldset class="flightFieldset">
			<legend>Fill Your Flight Information (Arrival)</legend>
			<div>
				<label for="arrival_airline">Airline</label>
				<input type="text" name="arrival_airline">
			</div>
			<div>
				<label for="arrival_flight_number">Flight Number</label>
			...
			?>
		<fieldset class="flightFieldset">
			<legend>Fill Your Flight Information (return)</legend>
			<div>
				<label for="departure_airline">Airline</label>
				<input type="text" name="departure_airline">
			</div>
			<div>
				<label for="departure_flight_number">Flight Number</label>
		...
		<input type="button" id="bookButton" value="Book Now"><span class="loading-icon"></span>
		<fieldset id="formErrors" class="formErrors"><legend>To reserve please fill the following</legend></fieldset>
	</form>
